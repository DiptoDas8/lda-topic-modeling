...
num_of_topics_entry.insert(END, '2')
...
num_of_frew_words_entry.insert(END, '3')
...
status.grid(row=4)
status_textarea = Text(status, height=10, width=65)
...
out.grid(row=5)
out_textarea = Text(out, height=10, width=65)
out_scroll = Scrollbar(out, command=out_textarea.yview)
status_textarea.configure(yscrollcommand=out_scroll.set)
